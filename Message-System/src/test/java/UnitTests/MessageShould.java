...
//            "2018-05-04T06:17| Message from the system with id13928| ICJDB| Message{timestamp=2018-05-04T06:17, message='Message from the system with id13928'}"
//    })
//    void return_string_representation(String timestamp, String messageText, String key, String expected){
////        LocalDateTime timestamp = LocalDateTime.parse("2018-03-13T16:55");
////        String messageText = "Message from the system with id16574";
////        String key = "EHFGB";
//
//        message = new Message(LocalDateTime.parse(timestamp), messageText, key);
//
